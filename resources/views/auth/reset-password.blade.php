                        ...
                        <form class="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4" action="{{route('password.update')}}" method="POST"
                            ...
                            <div class="mb-4">
                                ...
                                <input
                                    ...
                                    id="email" type="email" name="email" placeholder="Email" value="{{old('email',$request -> email)}}">
                            </div>
                            ...
                            <div class="mb-4">
                                ...
                                <input
                                    class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
                                    id="email" type="password" name="password_confirmation" placeholder="Confirm passeord" >
                            </div>
